    ...
    <div className="min-h-screen bg-slate-950 flex">
      ...
      `}>
        ...
        <nav className="flex-1 p-4 space-y-1">
          <button
            className="w-full flex items-center gap-3 px-4 py-3 rounded-xl bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 text-sm font-medium"
          >
          ...
          <button
            className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-slate-400 hover:bg-slate-800/60 hover:text-slate-200 transition-all text-sm font-medium"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-slate-500 text-xs">Manage and monitor all trails</p>
              </div>
            </div>
            ...
            <button
              onClick={loadTrails}
              disabled={loading}
              className="flex items-center gap-2 px-4 py-2 bg-slate-800/60 border border-slate-700/50 rounded-xl text-slate-300 text-sm hover:bg-slate-700/60 hover:border-slate-600 transition-all disabled:opacity-50"
            >
      ...
      {toast && (
        <div className="fixed bottom-6 right-6 z-[110] admin-fade-in">
          <div className={`flex items-center gap-3 px-5 py-3 rounded-xl shadow-2xl border backdrop-blur-xl ${
